function info() { 
    ...
    if (document.suscripcion.iphone.checked == true) {
     ...
     if (document.suscripcion.iphone.checked == true) {
        iphone = "<h4>" + document.suscripcion.lg.value + "</h4>";
        }
     else { lg = "" }
     if (document.suscripcion.iphone.checked == true) {
        iphone = "<h4>" + document.suscripcion.note.value + "</h4>";
        }
     else { note = "" }
   ...
   // console.log(deportes + noticias + economia + cultura + medioambiente)
    texto.innerHTML += deportes + noticias + economia + cultura + medioambiente + iphone + iphone +iphone + iphone + iphone
   }